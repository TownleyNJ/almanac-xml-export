...
class AapCommitteeassignment(models.Model):
    ...
    is_chair = models.NullBooleanField()
    is_rmm = models.NullBooleanField()
    is_vicechmn = models.NullBooleanField()
    last_edited = models.DateTimeField(blank=True, null=True)
...
class AapCongressionallineup(models.Model):
    ...
    state = models.ForeignKey('AapState')
...
class AapElectionresult(models.Model):
    ...
    nominated = models.NullBooleanField()
...
class AapKeyvote(models.Model):
    ...
    in_current_edition = models.BooleanField()
    last_edited = models.DateTimeField(blank=True, null=True)
...
class AapPerson(models.Model):
    ...
    narrative = models.TextField(blank=True)
    party = models.ForeignKey(AapParty, blank=True, null=True)
    caucuses_with = models.ForeignKey(AapParty, blank=True, null=True)
...
class AapState(models.Model):
    ...
    termlimits = models.NullBooleanField()
...
class AapTenure(models.Model):
    ...
    fullterm_label = models.NullBooleanField()
    last_edited = models.DateTimeField(blank=True, null=True)
...
class Districts(models.Model):
    ...
    locationid = models.ForeignKey('Locations', db_column='locationid')
    representativeid = models.ForeignKey('People', db_column='representativeid')
...
class Edition(models.Model):
    ...
    senmajparty = models.ForeignKey('Parties', db_column='senmajparty', blank=True, null=True)
    senminparty = models.ForeignKey('Parties', db_column='senminparty', blank=True, null=True)
    housemajpary = models.ForeignKey('Parties', db_column='housemajpary', blank=True, null=True)
    houseminparty = models.ForeignKey('Parties', db_column='houseminparty', blank=True, null=True)
...
class Locations(models.Model):
    ...
    presidentid = models.ForeignKey('People', db_column='presidentid', blank=True, null=True)
    vicepresidentid = models.ForeignKey('People', db_column='vicepresidentid', blank=True, null=True)
    governorid = models.ForeignKey('People', db_column='governorid', blank=True, null=True)
    srsenatorid = models.ForeignKey('People', db_column='srsenatorid', blank=True, null=True)
    jrsenatorid = models.ForeignKey('People', db_column='jrsenatorid', blank=True, null=True)
    electionsdivisionphone = models.CharField(max_length=40, blank=True)
    congfilingdeadline = models.DateField(blank=True, null=True)
    congfilingtbd = models.NullBooleanField()
    ...
    legistermlimits = models.NullBooleanField()
...
class People(models.Model):
    ...
    districtnumber = models.SmallIntegerField(blank=True, null=True)
    newlyelected = models.NullBooleanField()
    atlarge = models.NullBooleanField()
    ...
    fullterm = models.NullBooleanField()
